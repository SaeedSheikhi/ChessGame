...
import com.chess.engine.player.AI.AI;
import com.chess.engine.player.AI.BlackAIPlayer;
import com.chess.engine.player.AI.WhiteAIPlayer;
...
//        decideHumanAlliance(true,false);
//        decideAIAlliance(false, true);
...
//
//    private final void decideHumanAlliance(boolean whitePlayer, boolean blackPlayer){
//        if (whitePlayer) this.whitePlayer = new WhitePlayer(this, whiteStandardMoves, blackStandardMoves);
//        if (blackPlayer) this.blackPlayer = new BlackPlayer(this, blackStandardMoves, whiteStandardMoves);
//
//    }
//
//    private void decideAIAlliance(boolean whitePlayer, boolean blackPlayer){
//        if (whitePlayer) this.whitePlayer = new WhiteAIPlayer(this,whiteStandardMoves,blackStandardMoves);
//        if (blackPlayer) this.blackPlayer = new BlackAIPlayer(this.blackStandardMoves, whiteStandardMoves);
//    }
    @Override
